			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"flightinfo-display": {
								"semanticObject": "flightinfo",
								"action": "display",
								"description": "Overview of Flight Connections",
								"title": "Flight Information",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=flightinfo",
									"url": sap.ui.require.toUrl("flightinfo")
								}
							}
						}
					}
